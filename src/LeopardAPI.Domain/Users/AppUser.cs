...
namespace LeopardAPI.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update LeopardAPIDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LeopardAPIEfCoreEntityExtensionMappings to extend the IdentityUser entity
